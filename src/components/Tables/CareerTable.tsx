        ...
        <table className="w-full table-auto">
          ...
          <tbody>
            {careerList?.map((career, index) => (
              <tr key={index}>
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 xl:pl-7.5 ${index === careerList.length - 1 ? "border-b-0" : "border-b"
                    }`}
                >
                  <h5 className="text-dark dark:text-white">{career.name}</h5>
                </td>
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 ${index === careerList.length - 1 ? "border-b-0" : "border-b"
                    }`}
                >
                  <h5 className="text-dark dark:text-white">{career.email}</h5>
                </td>
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 ${index === careerList.length - 1 ? "border-b-0" : "border-b"
                    }`}
                ...
                >
                  <h5 className="text-dark dark:text-white">{career.coverLetter}</h5>
                </td>
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 ${index === careerList.length - 1 ? "border-b-0" : "border-b"
                    }`}
                >
                  <h5 className="text-dark dark:text-white">{career.roleAppliedFor}</h5>
                </td>
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 ${index === careerList.length - 1 ? "border-b-0" : "border-b"
                    }`}
                ...
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 xl:pr-7.5 ${index === careerList.length - 1 ? "border-b-0" : "border-b"
                    }`}
                >
                  <div className="flex items-center justify-end space-x-3.5">
                    <button className="hover:text-primary">
                      <Link href={`/detailed-page/${career.id}`}>
                        <svg
